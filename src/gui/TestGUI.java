...
public class TestGUI extends JPanel {
    ...
    public JPanel createPnInfor() {
        ...
        pn_infor.setPreferredSize(new Dimension(this.width, 300));
        
        // create panel avatar
        JPanel pn_avatar = new JPanel(new FlowLayout(1, 0, 25));
        pn_avatar.setPreferredSize(new Dimension(300, 300));
        
        this.lbImgSanPham = new JLabel("Avatar", JLabel.CENTER);
        this.lbImgSanPham.setPreferredSize(new Dimension(200, 250));
        ...
        JPanel pn_desc = new JPanel(new FlowLayout(1, 0, 15));
        ...
        pn_btn.setPreferredSize(new Dimension(200, 300));
    ...
    public JPanel createPnTable() {
        JPanel pn_table = new JPanel(new FlowLayout(1, 0, 10));
        ...
        table.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                IconModel icon_sp = new IconModel(200, 250, "SanPham/" + imgSanPham);
